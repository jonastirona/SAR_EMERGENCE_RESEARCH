...
starting_tile = 28-rid_of_top*9 # Change this CHANGEE
future = num_pred - 1
all_metrics = []
...
plt.suptitle('{} Results for AR{} (TW = {}h, RoT = {}, In = {}h)'.format(model_name, test_AR,num_pred,rid_of_top,num_in), y=0.99)
