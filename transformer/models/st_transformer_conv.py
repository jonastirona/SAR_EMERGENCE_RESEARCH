...
class SpatioTemporalTransformerConv(nn.Module):
    def __init__(self, input_dim, seq_len, embed_dim, num_heads, ff_dim, num_layers, output_dim, dropout, use_pre_mlp_norm=True):
        """
        Spatio-Temporal Transformer with Temporal Convolution for SAR emergence prediction.
        ...
        """
        super(SpatioTemporalTransformerConv, self).__init__()
        ...
        # Add temporal convolution layer
    ...
    def forward(self, x):  # x: (batch, seq_len, input_dim)
        ...
        x = x.transpose(1, 2)  # -> (batch, seq_len, embed_dim) back
