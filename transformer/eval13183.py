...
test_AR = 13183 # and the secondary will be 13165 and if I fix it, third: 13183
...
NOAA_first = datetime(2023, 1, 6, 0, 0, 0); NOAA_first_record = mdates.date2num(NOAA_first) # Convert to matplotlib date format
NOAA_second = datetime(2023, 1, 8, 0, 0, 0); NOAA_second_record = mdates.date2num(NOAA_second) # Convert to matplotlib date format
